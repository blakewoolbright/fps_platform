...
namespace ipc {
  ...
  //-------------------------------------------------------------------------------------------
  bool
  ShmSegment::validate_name( const std::string & name ) 
  {
  ...
  //-------------------------------------------------------------------------------------------
  bool
  ShmSegment::try_open( const std::string & name, Access access )
  {
    close() ;
    error_ = 0 ;
    flags_ = O_RDONLY ;
  ...
  //-------------------------------------------------------------------------------------------
  bool
  ShmSegment::try_create( const std::string & name, uint32_t size_in_bytes )
  {
    close() ;
  ...
  //-------------------------------------------------------------------------------------------
  bool 
  ShmSegment::reserve( uint32_t bytes ) 
  {
    error_ = 0 ;
