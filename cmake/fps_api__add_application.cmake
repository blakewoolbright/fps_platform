...
function( fps_add_application )
  ...
  foreach( variant ${required_variants} ) 
    ...
    if( FPS_VERBOSE )
      ...
      if( variant__include_dirs AND ${FPS_VERBOSE} GREATER 1 )
      ...
      if( variant__required_lib_files AND ${FPS_VERBOSE} GREATER 1 ) 
